// test/nodbus_plus_common.test.js
const test = require('node:test');
const assert = require('node:assert');

const nodbus = require('../');

const NodbusTcpServer = require('../src/server/nodbus_tcp_server.js');
const NodbusSerialServer = require('../src/server/nodbus_serial_server.js');
const TcpServer = require('../src/server/net/tcpserver.js');
const UdpServer = require('../src/server/net/udpserver.js');
const SerialServer = require('../src/server/net/serialserver.js');

const NodbusTcpClient = require('../src/client/nodbus_tcp_client.js');
const NodbusSerialClient = require('../src/client/nodbus_serial_client.js');
const TcpChannel = require('../src/client/net/tcpchannel.js');
const UdpChannel = require('../src/client/net/udpchannel.js');
const SerialChannel = require('../src/client/net/serialchannel.js');

test('nodbus-plus exports - factory functions commonjs', async (t) => {
